...
angular.module('awsSetup')
	.factory('awsService', ['$log', '$rootScope', 'localStorageService', 'aws', '$q', '$interval', function ($log, $rootScope, localStorageService, aws, $q, $interval) {
		...
		var service = {
			...
			setCustomAmiList: function (amiList) {
				localStorageService.set('customAmis', angular.toJson(amiList));
			},
			getCustomAmiList: function () {

				var customAmis = angular.fromJson(localStorageService.get('customAmis'));
